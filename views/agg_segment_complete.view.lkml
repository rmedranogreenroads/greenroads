view: agg_segment_complete {
  sql_table_name: `green-roads-285616.reporting_prod.agg_segment_complete`
    ;;
...
##################################
  ...
  measure: count {
    type: count
    drill_fields: [sg_context_library_name, sg_campaign_name, sg_product_added_campaign_name]
  }
}
